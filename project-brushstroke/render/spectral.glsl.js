// Vendored Spectral.js Kubelka-Munk GLSL — verbatim validated block (GLSL ES 3.00).
// Exported as a string so it can be injected between the fragment header decls and
// main(), and verified mechanically (glslangValidator). DO NOT hand-edit the body:
// it is the canonical KM mixer proven in the M3 pigment spikes. The guarded
// #ifndef SPECTRAL / #endif pair must remain intact (a known extraction hazard is
// dropping the closing #endif or leaking a stray template line).
export const SPECTRAL_GLSL = `    #ifndef SPECTRAL
    #define SPECTRAL
